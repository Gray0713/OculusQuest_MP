...
namespace VR_Multiplayer
{
    public class PlayerManager : MonoBehaviourPun, IPunObservable
    {
        ...
        [Tooltip("HTC Vive Right Hand Controller device")]
        public SteamVR_Input_Sources handType;

        [Tooltip("HTC Vive Touch Pad Action")]
        public SteamVR_Action_Boolean touchPadAction;       // Controls the turn-table interaction

        [Tooltip("HTC Vive Trigger Action")]
        public SteamVR_Action_Boolean triggerAction;        // Controls the laser interaction  
        ...
        private void Awake()
        {
            ...
            if (photonView.IsMine)
            {
                ...
                localVRHeadset = GameObject.Find("VRCamera").transform;         // Get transform data from local VR Headset
                localVRControllerLeft = GameObject.Find("LeftHand").transform;
                localVRControllerRight = GameObject.Find("RightHand").transform;
        ...
        private void Update()
        {
            if (photonView.IsMine)
            {
                ...
                // Control Rotating Platform upon activation of touch pad
